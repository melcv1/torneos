 ...
 * Page class
 */
class JugadorEdit extends Jugador
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JugadorEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "jugadoredit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("id_jugador") ?? Key(0) ?? Route(2)) !== null) {
                $this->id_jugador->setQueryStringValue($keyValue);
                $this->id_jugador->setOldValue($this->id_jugador->QueryStringValue);
            } elseif (Post("id_jugador") !== null) {
                $this->id_jugador->setFormValue(Post("id_jugador"));
                $this->id_jugador->setOldValue($this->id_jugador->FormValue);
            } else {
            ...
            if (Post("action") !== null) {
                ...
                if (($keyValue = Get("id_jugador") ?? Route("id_jugador")) !== null) {
                    ...
                    $this->id_jugador->CurrentValue = null;
                }
            }
