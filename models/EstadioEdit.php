 ...
 * Page class
 */
class EstadioEdit extends Estadio
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EstadioEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "estadioedit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("id_estadio") ?? Key(0) ?? Route(2)) !== null) {
                $this->id_estadio->setQueryStringValue($keyValue);
                $this->id_estadio->setOldValue($this->id_estadio->QueryStringValue);
            } elseif (Post("id_estadio") !== null) {
                $this->id_estadio->setFormValue(Post("id_estadio"));
                $this->id_estadio->setOldValue($this->id_estadio->FormValue);
            } else {
            ...
            if (Post("action") !== null) {
                ...
                if (($keyValue = Get("id_estadio") ?? Route("id_estadio")) !== null) {
                    ...
                    $this->id_estadio->CurrentValue = null;
                }
            }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->id_estadio->IsDetailKey) {
