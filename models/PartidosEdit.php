...
class PartidosEdit extends Partidos
{
    ...
    protected function editRow()
    {
        ...
        // ID_EQUIPO2
        $this->ID_EQUIPO2->setDbValueDef($rsnew, $this->ID_EQUIPO2->CurrentValue, null, $this->ID_EQUIPO2->ReadOnly);

        // ID_EQUIPO1
        $this->ID_EQUIPO1->setDbValueDef($rsnew, $this->ID_EQUIPO1->CurrentValue, null, $this->ID_EQUIPO1->ReadOnly);
        ...
        // DIA_PARTIDO
        $this->DIA_PARTIDO->setDbValueDef($rsnew, $this->DIA_PARTIDO->CurrentValue, null, $this->DIA_PARTIDO->ReadOnly);
        ...
        // GOLES_EQUIPO1
        $this->GOLES_EQUIPO1->setDbValueDef($rsnew, $this->GOLES_EQUIPO1->CurrentValue, null, $this->GOLES_EQUIPO1->ReadOnly);

        // GOLES_EQUIPO2
        $this->GOLES_EQUIPO2->setDbValueDef($rsnew, $this->GOLES_EQUIPO2->CurrentValue, null, $this->GOLES_EQUIPO2->ReadOnly);
