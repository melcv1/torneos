 ...
 * Page class
 */
class UsuarioDelete extends Usuario
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UsuarioDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("UsuarioList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("UsuarioList"); // Return to list
                return;
            }
        }
