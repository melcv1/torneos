 ...
 * Page class
 */
class JugadorDelete extends Jugador
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JugadorDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jugadordelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jugadorlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jugadorlist"); // Return to list
                return;
            }
        }
