 ...
 * Page class
 */
class PronosticadorDelete extends Pronosticador
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("pronosticadorlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("pronosticadorlist"); // Return to list
                return;
            }
        }
