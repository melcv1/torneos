 ...
 * Page class
 */
class EquipotorneoView extends Equipotorneo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EquipotorneoView";
    ...
    // CSS class/style
    public $CurrentPageName = "equipotorneoview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("ID_EQUIPO_TORNEO") ?? Route("ID_EQUIPO_TORNEO")) !== null) {
            ...
            $this->RecKey["ID_EQUIPO_TORNEO"] = $this->ID_EQUIPO_TORNEO->FormValue;
