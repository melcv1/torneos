 ...
 * Page class
 */
class JugadorView extends Jugador
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JugadorView";
    ...
    // CSS class/style
    public $CurrentPageName = "jugadorview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_jugador") ?? Route("id_jugador")) !== null) {
            $this->RecKey["id_jugador"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id_jugador") ?? Route("id_jugador")) !== null) {
            ...
            $this->RecKey["id_jugador"] = $this->id_jugador->QueryStringValue;
        } elseif (Post("id_jugador") !== null) {
            $this->id_jugador->setFormValue(Post("id_jugador"));
            $this->RecKey["id_jugador"] = $this->id_jugador->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_jugador->setQueryStringValue($keyValue);
            $this->RecKey["id_jugador"] = $this->id_jugador->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "jugadorlist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jugadorlist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
