 ...
 * Page class
 */
class EncuestaView extends Encuesta
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EncuestaView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID_ENCUESTA") ?? Route("ID_ENCUESTA")) !== null) {
                ...
                $returnUrl = "EncuestaList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "EncuestaList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "EncuestaList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
