 ...
 * Page class
 */
class JugadorequipoView extends Jugadorequipo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JugadorequipoView";
    ...
    // CSS class/style
    public $CurrentPageName = "jugadorequipoview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_jugadorequipo") ?? Route("id_jugadorequipo")) !== null) {
            $this->RecKey["id_jugadorequipo"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id_jugadorequipo") ?? Route("id_jugadorequipo")) !== null) {
            ...
            $this->RecKey["id_jugadorequipo"] = $this->id_jugadorequipo->QueryStringValue;
        } elseif (Post("id_jugadorequipo") !== null) {
            $this->id_jugadorequipo->setFormValue(Post("id_jugadorequipo"));
            $this->RecKey["id_jugadorequipo"] = $this->id_jugadorequipo->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_jugadorequipo->setQueryStringValue($keyValue);
            $this->RecKey["id_jugadorequipo"] = $this->id_jugadorequipo->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "jugadorequipolist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jugadorequipolist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
