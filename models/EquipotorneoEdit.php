 ...
 * Page class
 */
class EquipotorneoEdit extends Equipotorneo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EquipotorneoEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "equipotorneoedit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("ID_EQUIPO_TORNEO") ?? Key(0) ?? Route(2)) !== null) {
                $this->ID_EQUIPO_TORNEO->setQueryStringValue($keyValue);
                $this->ID_EQUIPO_TORNEO->setOldValue($this->ID_EQUIPO_TORNEO->QueryStringValue);
            } elseif (Post("ID_EQUIPO_TORNEO") !== null) {
                $this->ID_EQUIPO_TORNEO->setFormValue(Post("ID_EQUIPO_TORNEO"));
                $this->ID_EQUIPO_TORNEO->setOldValue($this->ID_EQUIPO_TORNEO->FormValue);
            } else {
            ...
            if (Post("action") !== null) {
                ...
                if (($keyValue = Get("ID_EQUIPO_TORNEO") ?? Route("ID_EQUIPO_TORNEO")) !== null) {
                    ...
                    $this->ID_EQUIPO_TORNEO->CurrentValue = null;
                }
            }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->ID_EQUIPO_TORNEO->IsDetailKey) {
