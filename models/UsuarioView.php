 ...
 * Page class
 */
class UsuarioView extends Usuario
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UsuarioView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("ID_USUARIO") ?? Route("ID_USUARIO")) !== null) {
            $this->RecKey["ID_USUARIO"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID_USUARIO") ?? Route("ID_USUARIO")) !== null) {
                ...
                $this->RecKey["ID_USUARIO"] = $this->ID_USUARIO->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->ID_USUARIO->setQueryStringValue($keyValue);
                $this->RecKey["ID_USUARIO"] = $this->ID_USUARIO->QueryStringValue;
            } elseif (!$loadCurrentRecord) {
                $returnUrl = "UsuarioList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "UsuarioList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "UsuarioList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
