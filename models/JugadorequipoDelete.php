 ...
 * Page class
 */
class JugadorequipoDelete extends Jugadorequipo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JugadorequipoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jugadorequipodelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jugadorequipolist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jugadorequipolist"); // Return to list
                return;
            }
        }
