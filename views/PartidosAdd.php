...
<?php $Page->equipo_local->EditAttrs->prepend("onchange", "ew.updateOptions.call(this);"); ?>
    <select
        ...
        data-select2-id="fpartidosadd_x_equipo_local"
        data-table="partidos"
...
<span id="el_partidos_equipo_visitante">
    <select
        ...
        data-select2-id="fpartidosadd_x_equipo_visitante"
        data-table="partidos"
...
<span id="el_partidos_ESTADIO">
    <select
        ...
        data-select2-id="fpartidosadd_x_ESTADIO"
        data-table="partidos"
...
<span id="el_partidos_PAIS_PARTIDO">
    <select
        ...
        data-select2-id="fpartidosadd_x_PAIS_PARTIDO"
        data-table="partidos"
...
<span id="el_partidos_ESTADO_PARTIDO">
    <select
        ...
        data-select2-id="fpartidosadd_x_ESTADO_PARTIDO"
        data-table="partidos"
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->automatico->isInvalidClass() ?>" data-table="partidos" data-field="x_automatico" name="x_automatico[]" id="x_automatico_358124" value="1"<?= ConvertToBool($Page->automatico->CurrentValue) ? " checked" : "" ?><?= $Page->automatico->editAttributes() ?> aria-describedby="x_automatico_help">
