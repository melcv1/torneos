...
loadjs.ready(["wrapper", "head"], function () {
    ...
    fpartidosadd.lists.ID_EQUIPO2 = <?= $Page->ID_EQUIPO2->toClientList($Page) ?>;
    fpartidosadd.lists.ID_EQUIPO1 = <?= $Page->ID_EQUIPO1->toClientList($Page) ?>;
...
<span id="el_partidos_ID_EQUIPO2">
    <select
        ...
        data-select2-id="fpartidosadd_x_ID_EQUIPO2"
        data-table="partidos"
...
loadjs.ready("fpartidosadd", function() {
    var options = { name: "x_ID_EQUIPO2", selectId: "fpartidosadd_x_ID_EQUIPO2" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fpartidosadd.lists.ID_EQUIPO2.lookupOptions.length) {
        options.data = { id: "x_ID_EQUIPO2", form: "fpartidosadd" };
    } else {
        options.ajax = { id: "x_ID_EQUIPO2", form: "fpartidosadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_partidos_ID_EQUIPO1">
    <select
        ...
        data-select2-id="fpartidosadd_x_ID_EQUIPO1"
        data-table="partidos"
...
<script>
loadjs.ready("fpartidosadd", function() {
    var options = { name: "x_ID_EQUIPO1", selectId: "fpartidosadd_x_ID_EQUIPO1" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fpartidosadd.lists.ID_EQUIPO1.lookupOptions.length) {
        options.data = { id: "x_ID_EQUIPO1", form: "fpartidosadd" };
    } else {
        options.ajax = { id: "x_ID_EQUIPO1", form: "fpartidosadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_partidos_ID_TORNEO">
    <select
        ...
        data-select2-id="fpartidosadd_x_ID_TORNEO"
        data-table="partidos"
...
<script>
loadjs.ready(["fpartidosadd", "datetimepicker"], function () {
