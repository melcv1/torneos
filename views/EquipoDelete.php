...
$Page->showMessage();
?>
<form name="fequipodelete" id="fequipodelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<?php if ($Page->usuario_dato->Visible) { // usuario_dato ?>
        <th class="<?= $Page->usuario_dato->headerCellClass() ?>"><span id="elh_equipo_usuario_dato" class="equipo_usuario_dato"><?= $Page->usuario_dato->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
