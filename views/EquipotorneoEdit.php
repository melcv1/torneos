...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fequipotorneoedit = new ew.Form("fequipotorneoedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fequipotorneoedit;

    // Add fields
    var fields = currentTable.fields;
    fequipotorneoedit.addFields([
    ...
    // Form_CustomValidate
    fequipotorneoedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fequipotorneoedit.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fequipotorneoedit.lists.ID_TORNEO = <?= $Page->ID_TORNEO->toClientList($Page) ?>;
    fequipotorneoedit.lists.ID_EQUIPO = <?= $Page->ID_EQUIPO->toClientList($Page) ?>;
    fequipotorneoedit.lists.GRUPO = <?= $Page->GRUPO->toClientList($Page) ?>;
    fequipotorneoedit.lists.POSICION_EQUIPO_TORENO = <?= $Page->POSICION_EQUIPO_TORENO->toClientList($Page) ?>;
    loadjs.done("fequipotorneoedit");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fequipotorneoedit" id="fequipotorneoedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->crea_dato->Visible) { // crea_dato ?>
    <div id="r_crea_dato"<?= $Page->crea_dato->rowAttributes() ?>>
        <label id="elh_equipotorneo_crea_dato" for="x_crea_dato" class="<?= $Page->LeftColumnClass ?>"><?= $Page->crea_dato->caption() ?><?= $Page->crea_dato->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->modifica_dato->Visible) { // modifica_dato ?>
    <div id="r_modifica_dato"<?= $Page->modifica_dato->rowAttributes() ?>>
        <label id="elh_equipotorneo_modifica_dato" for="x_modifica_dato" class="<?= $Page->LeftColumnClass ?>"><?= $Page->modifica_dato->caption() ?><?= $Page->modifica_dato->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->usuario_dato->Visible) { // usuario_dato ?>
    <div id="r_usuario_dato"<?= $Page->usuario_dato->rowAttributes() ?>>
        <label id="elh_equipotorneo_usuario_dato" for="x_usuario_dato" class="<?= $Page->LeftColumnClass ?>"><?= $Page->usuario_dato->caption() ?><?= $Page->usuario_dato->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
