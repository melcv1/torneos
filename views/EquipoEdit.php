...
loadjs.ready(["wrapper", "head"], function () {
    ...
    fequipoedit.lists.NOM_ESTADIO = <?= $Page->NOM_ESTADIO->toClientList($Page) ?>;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fequipoedit_x_NOM_ESTADIO"
        data-table="equipo"
...
<script>
loadjs.ready("fequipoedit", function() {
    var options = { name: "x_NOM_ESTADIO", selectId: "fequipoedit_x_NOM_ESTADIO" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fequipoedit.lists.NOM_ESTADIO.lookupOptions.length) {
        options.data = { id: "x_NOM_ESTADIO", form: "fequipoedit" };
    } else {
        options.ajax = { id: "x_NOM_ESTADIO", form: "fequipoedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<?php if ($Page->crea_dato->Visible) { // crea_dato ?>
    <div id="r_crea_dato"<?= $Page->crea_dato->rowAttributes() ?>>
        <label id="elh_equipo_crea_dato" for="x_crea_dato" class="<?= $Page->LeftColumnClass ?>"><?= $Page->crea_dato->caption() ?><?= $Page->crea_dato->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->modifica_dato->Visible) { // modifica_dato ?>
    <div id="r_modifica_dato"<?= $Page->modifica_dato->rowAttributes() ?>>
        <label id="elh_equipo_modifica_dato" for="x_modifica_dato" class="<?= $Page->LeftColumnClass ?>"><?= $Page->modifica_dato->caption() ?><?= $Page->modifica_dato->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->usuario_dato->Visible) { // usuario_dato ?>
    <div id="r_usuario_dato"<?= $Page->usuario_dato->rowAttributes() ?>>
        <label id="elh_equipo_usuario_dato" for="x_usuario_dato" class="<?= $Page->LeftColumnClass ?>"><?= $Page->usuario_dato->caption() ?><?= $Page->usuario_dato->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
