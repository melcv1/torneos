...
$Page->showMessage();
?>
<form name="festadiodelete" id="festadiodelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
