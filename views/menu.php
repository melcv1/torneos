...
$topMenu->addMenuItem(2, "mi_encuesta", $MenuLanguage->MenuPhrase("2", "MenuText"), $MenuRelativePath . "encuestalist", -1, "", IsLoggedIn() || AllowListMenu('{1FEE5CED-11BB-4991-94A0-946354AE0202}encuesta'), false, false, "", "", true, false);
...
$sideMenu->addMenuItem(2, "mi_encuesta", $MenuLanguage->MenuPhrase("2", "MenuText"), $MenuRelativePath . "encuestalist", -1, "", IsLoggedIn() || AllowListMenu('{1FEE5CED-11BB-4991-94A0-946354AE0202}encuesta'), false, false, "", "", true, true);
